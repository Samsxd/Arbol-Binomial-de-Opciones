...
<body data-spy="scroll" data-target="#contenedor" style=" position: relative; background-color:black;">
    <h1 style="text-align: center; font-family: initial; color:ivory;">Valoración de Opciones</h1>
                ...
                <div id="data-content" class="container-fluid card">
                    ...
                    <div class="input-group input-group-sm mb-3">
                        ...
                        <select class="custom-select" id="pos">
                            ...
                            <option value="3">Corto Put</option>
                        </select>
                    </div>
                    <button type="button" onclick="algo()" class="btn btn-warning btn-sm btn-block">Generar</button>

                    <footer class="bg-dark rounded-top">
                        <div class="row justify-content-md-center" style="color: whitesmoke;">
                            <div class="container-fluid" style="display:inline">
                                <div style="align-items: center; text-align: center;">
                                    <p> Autor &copy; Samuel Sepúlveda </p>
                                    <p> Proyecto de Aula </p>
                                    <p> Valoración de Derivados Financieros </p>
                                </div>
                            </div>
                        </div>
                    </footer>
